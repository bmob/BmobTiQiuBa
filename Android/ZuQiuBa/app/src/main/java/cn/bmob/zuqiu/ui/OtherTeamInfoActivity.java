...
public class OtherTeamInfoActivity extends BaseActivity{
	...
	protected void onCreate(Bundle bundle) {
		...
		setUpAction(mActionBarTitle, "球队管理", 0, View.VISIBLE);
		Bundle bd = getIntent().getBundleExtra("data");
		OtherTeamInfoFragment f = new OtherTeamInfoFragment();
		if(bd!=null){
			f.setArguments(bd);
		}
		// 添加显示第一个fragment
