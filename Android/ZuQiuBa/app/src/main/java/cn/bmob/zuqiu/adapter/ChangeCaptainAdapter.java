...
public class ChangeCaptainAdapter extends BaseAdapter{

	private Context mContext;
	private List<User> data = new ArrayList<User>();
	private int selectedItem;
	
	public ChangeCaptainAdapter(Context mContext, List<User> data) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			convertView = ((LayoutInflater)mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.item_icon_and_name_checkbox, null);
