...
<div class="container-fluid">
	...
	<div class="row">
		<div class="positionrl">
			<img src="<?php echo Yii::app()->params['themeAssetHost'] ?>images/playground-blue-yellow.png" class="autosize-img" width="720" height="1046"/>
			<div class="wrap-left-top-n">
				<p>他的平均得分是<br/><span class="font-large-y"><?php echo $score ?></span></p>
			</div>
		</div>
	</div>
</div>
